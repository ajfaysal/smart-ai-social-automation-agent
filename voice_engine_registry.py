...
def run_command_engine(engine: str, text: str, output: Path, reference: Path | None, character_id: str, acting_directive: str | None = None, target_language: str | None = None) -> None:
